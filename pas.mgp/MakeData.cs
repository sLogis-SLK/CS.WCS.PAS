...
public class MakeData
{
  ...
  public static List<Rebuild> REBUILDParsing(string sPath, string sDate, string sBatch)
  {
    ...
    if (!File.Exists(str1))
      return rebuildList;
    string str2;
    string str3 = str2 = $"{Common.PATH_STARTUP}{Common.PATH_TEMP}\\{Path.GetRandomFileName()}";
    File.Copy(str1, str3);
  ...
  public static bool REBUILDComplete(string sPath, string sDate, string sBatch)
  {
    ...
    try
    {
      ...
      if (!File.Exists(str2))
        return false;
      str1 = $"{Common.PATH_STARTUP}{Common.PATH_TEMP}\\{Path.GetRandomFileName()}";
      File.Copy(str2, str1);
